...
class Window(tk.Tk):  # class window created and is inheriting from built-in class tk.Tk of tkinter
    def __init__(self, update):  # constructor created for the class
        ...
        self.options = ["update info", "past orders"]
        ...
        self.button = Button(self, text='Proceed', command=lambda: self.destroy_and_proceed())
        self.button.pack()

        self.update = update

        self.view_cart = ViewCart()

    def destroy_and_proceed(self):
